...
export default function UpdateAboutCategory({ contactId, aboutCategoryId }) {
    ...
    const handleUpdateAboutCategory = async () => {
        ...
        try {
            await axios.put(`${BASE_URL}/contact/${contactId}/aboutcategory/${aboutCategoryId}`, newAboutCategory)
            console.log()
            setShow(false);
        }
        catch (err) {
    ...
    return (
        <>
            <button onClick={handleShow}>Edytuj</button>
            <Modal
                show={show}
                onHide={handleClose}
                backdrop="static"
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Zaktualizuj kategorię</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form>
                ...
                <Modal.Footer>
                    ...
                    <button variant="primary" onClick={handleUpdateAboutCategory}>Zaktualizuj</button>
                </Modal.Footer>
            </Modal>
        </>
    )
